...
pub async fn record_change(
    ...
    if let Some(previous_id) = previous_revision_id {
        ...
        if previous.page_id != page.page_id || previous.site_id != page.site_id {
    ...
    ctx.transaction().execute_raw(Statement::from_sql_and_values(
        ...
        [event_id.into(), page.site_id.into(), revision.user_id.into(),
         page.page_category_id.into(), page.page_id.into()],
...
async fn auto_watch_edited_page(
    ...
    if !PageService::check_user_permission(
        ctx,
