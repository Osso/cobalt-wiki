...
pub fn normalize(text: &mut String) {
    ...
    // Colons after the first stay: Wikidot's WDStringUtils::toUnixName keeps
    // them in the page name ("a:b:c" is category "a", page "b:c").
...
fn test_normalize() {
    ...
    check!(
        "writing:2022-03-27-slave-pens:freedom-or-vengeance",
        "writing:2022-03-27-slave-pens:freedom-or-vengeance",
    );
