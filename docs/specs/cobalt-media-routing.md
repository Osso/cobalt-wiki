...
- [x] Native gallery viewing (`cef28e93b`, `01e1bfaa4`, formatting/types `28b30c9cc`) is artifact-deployed through shared Framerail HEAD `3f9c20249b082416a8c661bab34685d4fcf67c31`. Local and production build trees match (500 files; SHA-256 `bc8daab87d1aa10bf781395e111ba8380f330de3ba8daaea34587a810c315359`; `/tmp/claude/cobalt-badges-production-artifact.json`). Component/browser tests passed 3/3 (`/tmp/claude/cobalt-badges-node-tests.log`); main inspected `/tmp/claude/cobalt-badges-viewer-fixed.png`. Independent public Chromium proof passes: 77 images, original-image viewer, Next/Previous, last-image boundary, Escape and Close keep `/badges`; 118 requests with zero non-read requests (`/tmp/claude/cobalt-badges-production-viewer.log`). Public screenshot capture hung and was terminated; public acceptance is DOM/interaction evidence, not screenshot parity. Five existing imported-history type errors remain outside this scope.
