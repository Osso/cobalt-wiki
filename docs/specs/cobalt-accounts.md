...
- [x] Only trusted callers create links for a given user (the invite tool over a loopback Deepwell endpoint). Framerail never calls `password_token_create` or `password_token_status`.
