...
- [ ] Membership applications are documented by the [membership applications](cobalt-member-applications.md) spec, including their locally integrated Join and Site members surfaces, verification status, and lifecycle.
